    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="shoppingApp.category.name">Name</Translate>
            </span>
          </dt>
          <dd>{categoryEntity.name}</dd>
          <dt>
            <span id="createdDate">
              <Translate contentKey="shoppingApp.category.createdDate">Created Date</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="createdBy">
              <Translate contentKey="shoppingApp.category.createdBy">Created By</Translate>
            </span>
          </dt>
          <dd>{categoryEntity.createdBy}</dd>
          <dt>
            <span id="lastModifiedBy">
              <Translate contentKey="shoppingApp.category.lastModifiedBy">Last Modified By</Translate>
            </span>
          </dt>
